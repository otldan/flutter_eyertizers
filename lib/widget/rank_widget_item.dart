              ...
              children: <Widget>[
               ClipRRect(
                ...
                Positioned(
                  ...
                  top: 10,
                  child:
                  Opacity(opacity: showCategory ? 1.0 : 0.0,
                  child: ClipOval(
                    child: Container(
                      ...
                      child: Text(item.data.category,style: TextStyle(fontSize: 14,color: Colors.white),),
                    ),
                  ),),
                ),
                ...
                Positioned(
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Text(DateUtil.formatDateMs(item.data.duration  * 1000,format: 'mm:ss',),
